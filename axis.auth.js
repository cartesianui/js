...
axis.auth = axis.auth || {};
      ...
      axis.auth.isGranted = function (permissionName) {
        return axis.auth.allPermissions[permissionName] != undefined &&
      ...
      axis.auth.tokenCookieName = 'Abp.AuthToken';

      axis.auth.setToken = function (authToken, expireDate) {
        axis.utils.setCookieValue(axis.auth.tokenCookieName, authToken, expireDate, axis.appPath, axis.domain);
      };
      ...
      axis.auth.refreshTokenCookieName = 'Abp.AuthRefreshToken';

      axis.auth.setRefreshToken = function (refreshToken, expireDate) {
          axis.utils.setCookieValue(axis.auth.refreshTokenCookieName, refreshToken, expireDate, axis.appPath, axis.domain);
      };
